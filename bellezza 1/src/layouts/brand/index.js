...
function Brand() {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await axios.get("http://localhost:8000/admin/listbrand");
  ...
  const handleAddBrand = (e) => {
    ...
    reader.onloadend = async () => {
      ...
      axios
        .post("http://localhost:8000/admin/addbrand", formData)
        .then((response) => {
  ...
  const handleEditBrand = (e) => {
    ...
    if (image) {
      ...
      reader.onloadend = async () => {
        ...
        axios
          .put(`http://localhost:8000/admin/editbrand/${selectedProduct._id}`, formData)
          .then((response) => {
            console.log(response);
  ...
  const deleteBrand = async (id) => {
    try {
      await axios.delete(`http://localhost:8000/admin/removebrand/${id}`);
